var margin = {left:0, top:40, right:120, bottom:50},
    ...
    innerRadius = Math.min(width * 1.45, height * .55),
    outerRadius = innerRadius * 1.05;
	
//Recalculate the width and height now that we know the radius
width = outerRadius * 2 + margin.right + margin.left + 400;
height = outerRadius * 2 + margin.top + margin.bottom + 100;
	
//Reset the overall font size
var newFontSize = Math.min(70, Math.max(40, innerRadius * 95 / 250));
...
d3.json('lotr_words_location.json', function (error, dataAgg) {
	...
	var dataChar = d3.nest()
		...
		.rollup(function(leaves) { return d3.sum(leaves, function(d) { return d.MOs; }); })
		.entries(dataAgg)
	...
	//var colors = ["#b3bfc4", "#09b4c7",   "#009f9b", "#0573b3", "#d44d00",  "#cd75a7",    "#0f2e54", "#C6CAC9", "#373F41", "#47635f",     "#D6CD79",   "#3C7E16", "#8D9413", "#ecb63d", "#09b4c7",   "#009f9b", "#0573b3", "#d44d00",  "#cd75a7",    "#0f2e54", "#C6CAC9", "#373F41", "#47635f","#D6CD79",   "#3C7E16", "#8D9413", "#ecb63d", "#09b4c7",   "#009f9b", "#0573b3", "#d44d00",  "#cd75a7" ];
	var colors = ["#b3bfc4", "#4d5a6c",   "#8196B5", "#7770A4", "#425F6C ",  "#fed7d7",    "#a9a9a9", "#CCC7AF", "#c4b8b3", "#9da470",     "#A39FC2",   "#198c8c", "#86ccb6", "#b3bfc4", "#4d5a6c",   "#8196B5", "#7770A4", "#425F6C ",  "#fed7d7",    "#a9a9a9", "#CCC7AF", "#c4b8b3", "#9da470","#A39FC2",   "#198c8c", "#86ccb6", "#b3bfc4", "#4d5a6c",   "#8196B5", "#7770A4", "#425F6C ",  "#fed7d7" ];


//old var colors = ["#b3bfc4", "#4d5a6c",   "#8196B5", "#7770A4", "#425F6C ",  "#fed7d7",    "#a9a9a9", "#CCC7AF", "#c4b8b3", "#9da470",    "#A39FC2",   "#198c8c", "#8D9413", 
				  //"#b3bfc4", "#4d5a6c",   "#8196B5", "#7770A4", "#425F6C ",  "#fed7d7",    "#a9a9a9", "#CCC7AF", "#c4b8b3", "#9da470",	"#A39FC2",   "#198c8c", "#8D9413", 
				  //"#b3bfc4", "#4d5a6c",   "#8196B5", "#7770A4", "#425F6C ",  "#fed7d7" ];

//var colors = ["#fed7d7", "#a9a9a9",   "#ccc7af", "#198c8c", "#86ccb6",  "#b2868e",    "#ddae36", "#61c680", "#b266b2", "#ccccff",     "#a8cc798",   "#e34132", "#c0d725", "#b3bfc4", "#fed7d7", "#a9a9a9",   "#ccc7af", "#198c8c", "#86ccb6",  "#b2868e",    "#ddae36", "#61c680", "#b266b2", "#ccccff",     "#a8cc798",   "#e34132", "#c0d725", "#b3bfc4", "#fed7d7", "#a9a9a9",   "#ccc7af", "#198c8c", "#86ccb6" ];

//var colors = ["#fed7d7", "#a9a9a9",   "#3232d6", "#198c8c", "#86ccb6",  "#b2868e",    "#ddae36", "#61c680", "#b266b2", "#ccccff",     "#a8cc798",   "#e34132", "#c0d725", "#b3bfc4", "#fed7d7", "#a9a9a9",   "#3232d6", "#198c8c", "#86ccb6",  "#b2868e",    "#ddae36", "#61c680", "#b266b2", "#ccccff",     "#a8cc798",   "#e34132", "#c0d725", "#b3bfc4", "#fed7d7", "#a9a9a9",   "#3232d6", "#198c8c", "#86ccb6" ];


//	var colors = ["#5a3511", "#47635f",   "#223e15", "#C6CAC9", "#0d1e25",  "#53821a",    "#4387AA",         "#770000", "#373F41", "#602317",     "#8D9413",   "#c17924", "#3C7E16"]

//var colors = ["#ddae36", "#44606c",   "#b266b2", "#ccccff", "#b7d698",  "#c96c69",    "#c0d725", "#ddae36", "#85D6EA",   "#b266b2", "#ccccff", "#b7d698",  "#c96c69",    "#c0d725"
//			 ,"#ddae36", "#44606c",   "#b266b2", "#ccccff", "#b7d698",  "#c96c69",    "#c0d725", "#ddae36", "#85D6EA",   "#b266b2", "#ccccff", "#b7d698",  "#c96c69",    "#c0d725",
//			 ,"#ddae36", "#85D6EA",   "#b266b2", "#ccccff", "#b7d698" ];
	...
	var outerLabels1 = arcs.append("g")
		.each(function(d) { d.angle = ((d.startAngle + d.endAngle) / 2); })
		.attr("class", "outer-labels1")
		.attr("text-anchor", function(d) { return d.angle > Math.PI ? "end" : null; })
		.attr("transform", function(d,i) { 
			var c = arc.centroid(d);
			return "translate(" + (c[0] + d.pullOutSize) + "," + c[1] + ")"
	...
	//The value below it
	outerLabels1.append("text")
		.attr("class", "outer-label-value")
		.attr("dy", ".35em")
		.text(function(d,i){ return numFormat(d.value) + " MOs"; });
	  ...
	  .enter().append("text")
	    ...
	    .text(function(d,i) { return d.name; })
 	 	.on("mouseover", function(d) {
			...
			d3.selectAll(".outer-label-value")
				.text(function(s,i){
					...
					return numFormat(value) + (value === 1 ? " MOs" : " MOs"); 
     	...
     	.on("mouseout", function(d) {
			...
			d3.selectAll(".outer-label-value")	
				.text(function(s,i){ return numFormat(s.value) + " MOs"; });
